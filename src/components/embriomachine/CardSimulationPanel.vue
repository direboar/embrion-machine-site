              ...
              >
                <v-flex xs8>
                  ...
                  >
                    ...
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content>カード総数（補助パーツを除く）</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                    <v-list-tile>
                    ...
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content>山札をシャッフルした回数</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                  </v-list>
                </v-flex>
                <v-flex xs4>
                  ...
                  >
                    <v-list-tile>
                      <v-list-tile-content class="subheaders">{{deck.evadeRate}}</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content class="subheaders">{{deck.cards.length}}</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content class="subheaders">{{deck.deck.length}}</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content class="subheaders">{{deck.drowCardCount}}</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                    <v-list-tile>
                      <v-list-tile-content class="subheaders">{{deck.shuffleCount}}</v-list-tile-content>
                    </v-list-tile>
                    <v-divider />
                  </v-list>
                </v-flex>
            ...
            <v-card>
              ...
              >
                ...
                >
                  ...
                  <v-list-tile-content class="subheaders">{{card.name}}</v-list-tile-content>
                  <v-list-tile-action>
                    <v-btn
                      color="grey darken-4"
                      flat
  ...
  watch: {
    showDialog(val) {
      if (val) {
        ...
        this.deck.setArmor(this.machine.machineType.armorPoint);
